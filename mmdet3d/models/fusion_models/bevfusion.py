    ...
    def forward_single(
        ...
        **kwargs,
        ...
        for sensor in (
            ...
            if sensor == "camera":
                if self.pretraining and points_2 is not None:
        ...
        if self.training:
            ...
            if self.pretraining:
                ...
                #     img3=torchvision.utils.draw_bounding_boxes(gray_scale_1.unsqueeze(0),pooled_bbox_2[0]//8,colors="red") / 255.#.numpy()
                #     img4=torchvision.utils.draw_bounding_boxes(gray_scale_2.unsqueeze(0),pooled_bbox_2[0]//8,colors="red") / 255.#.numpy()
                #     # saved_image = torchvision.utils.make_grid([img1,img2], nrow=1)
                #     torchvision.utils.save_image([img1,img2,img3,img4], os.path.join(self.save_dir,str(self.counter)+'.png'))
