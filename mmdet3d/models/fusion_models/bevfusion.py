        ...
        **kwargs,
        ...
        if self.training:
            ...
            if self.pretraining:
                ...
                img1=torchvision.utils.draw_bounding_boxes(gray_scale_1.unsqueeze(0),pooled_bbox[0]//8,colors="red")
                print(img1.shape)
                img2=torchvision.utils.draw_bounding_boxes(gray_scale_2.unsqueeze(0),pooled_bbox[0]//8,colors="red")
