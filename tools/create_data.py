...
def nuscenes_data_prep(
    ...
    if load_augmented is None:
        ...
        nuscenes_converter.create_nuscenes_infos(
            root_path, info_prefix, version=version, max_sweeps=max_sweeps, fewshot=args.fewshot
        )
...
parser.add_argument('--fewshot', help='proportion of few-shot training data', type=float, default=1.)
parser.add_argument(
    "--root-path",
    type=str,
    default="./data/kitti",
...
if __name__ == "__main__":
    ...
    if args.dataset == "nuscenes" and args.version != "v1.0-mini":
        ...
        #FIXME: ignore the below part while creating few-shot learning dataset
